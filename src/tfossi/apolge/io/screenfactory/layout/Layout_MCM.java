...
/**
 * Layout für Menu-CommandMenu-Screen
 * 
 * @author tfossi
 * @version 12.08.2014
 * @modified -
...
public class Layout_MCM {
	...
	/** ttt */
	private final String ttt = "Allgemeine Befehle";
...
//		FIXME 13.01.2015
		...
		data.top = new FormAttachment(groups.get(Screen.VI), 0, SWT.BOTTOM);
