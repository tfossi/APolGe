...
public abstract class _AType<T> {
	 ...
	 */
	public _AType(final String name, final String nameDescription, final String value,
			final String key, final String[][] keyValue,
			final Map<String, _AType<?>> atypeRegister, Map<Number,Element> elementRegister) {
		this.name = name;
