 ...
 * @since Java 1.6
 */
public class ClientView extends AView {
...
//	}
	...
	public void update(final Observable editorMenu, final Object notifyScreens) {
		...
		ClientMenu menu = (ClientMenu) editorMenu;
	...
	/** logger */
	private final static Logger logger = Logger.getLogger(ClientView.class
			.getPackage().getName());
	 ...
	 * @modified -
	 */
	public ClientView(Cntr cntr) {
		super(cntr, new CommandMaps().fetchList(CLIENTVIEW));
