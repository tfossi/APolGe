...
/**
 * Befehl: Aktiviere Server. <br>
 * Aufruf durch Macro 'Autostart Server'. Gehört zur Gruppe der menuspezifischen
 * Befehle.<br/>
 * <b>Befehl: </b>ActivateServer<br>
 * <b>Optionen:</b> [keine] <br>
 * Aufruf <code>IUnvisible</code>
 * 
 ...
 * @since Java 1.6
 */
public class ActivateServer extends ACmd {
	...
	public enum c {
		...
		public void call(ICmd cmd, String... value) {
			// ((ServerMenu)cmd.getReceiver()).activateGameServer();
			cmd.help();
		}
	...
	public final void command() {
		...
		((ServerMenu) this.getReceiver()).activateGameServer();
	}
	...
	private final static Logger logger = Logger
			.getLogger(ActivateServer.class.getPackage().getName());

	/**
	 * Befehl: Aktiviere Server. <br>
	 * Aufruf durch Macro 'Autostart Server'
	 */
	 ...
	 * @modified -
	 */
	public ActivateServer(final String name, boolean unvisibleMode) {
