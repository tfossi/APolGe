 ...
 * @since Java 1.6
 */
public class CLTAutoRun extends ACmd implements IUnvisible {
...
//			((ServerMenu)cmd.getReceiver()).activateGameServer();
	...
	public final void command() {
		...
		((ClientMenu)this.getReceiver()).autoRunClient();
	}
...
setTestMenuFont(button);
	...
	/** logger */
	private final static Logger logger = Logger.getLogger(CLTAutoRun.class
			.getPackage().getName());
	 ...
	 * @modified -
	 */
	public CLTAutoRun(final String name, boolean unvisibleMode) {
