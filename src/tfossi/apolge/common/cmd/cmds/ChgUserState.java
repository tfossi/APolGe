 ...
 * @since Java 1.6
 */
public class ChgUserState extends ACmd implements IUnvisible {
	...
	public enum c {
		 ...
		 */
		@SuppressWarnings("static-method")
		public void call(ICmd cmd, String... value) throws InvalidClassException, SocketException, IOException {
			((IUserStateCall) cmd.getReceiver()).aufrufUs(cmd.getData(),
			value);
		}
	...
	/** logger */
	private final static Logger logger = Logger.getLogger(ChgUserState.class
			.getPackage().getName());
	 ...
	 * @modified -
	 */
	public ChgUserState(final String name, boolean unvisibleMode) {
