...
/** 
 * Guard überwacht, dass eine Transition vor einem Zeitpunkt stattfindet. 
 *
 * @author tfossi
 * @version 26.01.2015
 * @modified -
 * @since Java 1.6
 */
public class After_ implements _Guard{
	/** clock */
	 ...
	 * @modified -
	 */
	public After_(final PreAddress address, Object datetime){		
...
//		return  CM_DateTime.after((CPiT)index, tstClock);
		return false;
